/** Default legal copy for SiteContent seed (editable via Owner Admin → Website Content). */

export const DEFAULT_TERMS_CONTENT = `Ordo Stage
Legal Documents

Schwifty
Strandgade 1, 5700 Svendborg, Denmark
VAT: DK28625383
mail@ordostage.com
...
2. The service
Ordo Stage is provided "as is" and "as available." We do our best to keep things running smoothly, but we don't guarantee uninterrupted or error-free access.
3. Your data
You are responsible for the data you store in Ordo Stage. While we take reasonable care to maintain the service, we do not guarantee that your data will be preserved. You should keep your own backups of any information that matters to you.
We are not liable for any loss, corruption, or accidental deletion of your data, whether caused by technical failure, human error, or any other reason.
...
Flex bills you each month for billable seats in the previous calendar month, using the tiered seat pricing published on our pricing page. Billing is postpaid (you are invoiced after the month of use). A seat added mid-month is charged only for the remaining UTC days of that month; subsequent months are charged in full when the seat remains billable. Invoices are typically issued on the 1st for the prior month and are due within the payment period stated on the invoice (default 7 days). No credit card is required to start Flex; if you decide not to continue, you can stop paying and stop using the service. New workspaces may include a trial period where unpaid invoices do not restrict access; after any trial, and where we have configured a grace period, a short grace period may apply after the due date before access is restricted.
...
To exercise any of these rights, contact us at mail@ordostage.com. We will respond within 30 days.
8. Cookies
We use only essential cookies necessary to operate the service. We do not use tracking or advertising cookies.
9. Data breaches
In the event of a personal data breach that is likely to affect your rights, we will notify you and the Danish Data Protection Agency (Datatilsynet) within 72 hours of becoming aware, as required by law.
10. Complaints
If you believe we are handling your data unlawfully, you have the right to lodge a complaint with the Danish Data Protection Agency:
