...
export const CreateLeaveAdjustmentSchema = z.object({
  ...
  note: z.string().min(1),
  /** Calendar date for when overtime was earned (stored as periodStart). */
...
export const TimeTravelClaimSchema = z.object({
  ...
  dayLines: z.array(z.object({
    ...
    lodgingPlaceId: z.string().optional().default(""),
    lodgingLabel: z.string().optional().default(""),
...
export const ProductionSchema = z.object({
  ...
  techCount: z.number().int().nullable().optional(),
  durationMinutes: z.number().int().nullable().optional(),
  stageWidth: z.string().nullable().optional(),
  stageDepth: z.string().nullable().optional(),
  stageHeight: z.string().nullable().optional(),
...
export const CreateProductionSchema = z.object({
  ...
  techCount: z.number().int().min(0).nullable().optional(),
  durationMinutes: z.number().int().min(0).nullable().optional(),
  stageWidth: z.string().nullable().optional(),
  stageDepth: z.string().nullable().optional(),
  stageHeight: z.string().nullable().optional(),
  actorNames: z.array(z.string().trim().min(1)).max(100).optional(),
  techNames: z.array(z.string().trim().min(1)).max(100).optional(),
  stageSize: z.string().nullable().optional(),
  technicalSpecs: z.string().nullable().optional(),
