...
toursRouter.post("/tours/:id/shows", zValidator("json", CreateTourShowSchema), async (c) => {
  ...
  const show = await prisma.tourShow.create({
    data: {
      ...
      venueStreet:  body.venueStreet  ?? null,
      venueNumber:  body.venueNumber  ?? null,
      venueZip:     body.venueZip     ?? null,
      ...
      hotelStreet:  body.hotelStreet  ?? null,
      hotelNumber:  body.hotelNumber  ?? null,
      hotelZip:     body.hotelZip     ?? null,
      hotelCity:    body.hotelCity    ?? null,
      hotelState:   body.hotelState   ?? null,
  ...
  async (c) => {
    ...
    const show = await prisma.tourShow.update({
      ...
      data: {
        ...
        ...(body.venueStreet  !== undefined && { venueStreet:  body.venueStreet }),
        ...(body.venueNumber  !== undefined && { venueNumber:  body.venueNumber }),
        ...(body.venueZip     !== undefined && { venueZip:     body.venueZip }),
        ...(body.venueCity    !== undefined && { venueCity:    body.venueCity }),
        ...(body.venueState   !== undefined && { venueState:   body.venueState }),
        ...(body.venueCountry !== undefined && { venueCountry: body.venueCountry }),
        ...(body.contactName  !== undefined && { contactName:  body.contactName }),
        ...(body.contactPhone !== undefined && { contactPhone: body.contactPhone }),
        ...(body.contactEmail !== undefined && { contactEmail: body.contactEmail }),
        ...(body.hotelName    !== undefined && { hotelName:    body.hotelName }),
        ...(body.hotelStreet  !== undefined && { hotelStreet:  body.hotelStreet }),
        ...(body.hotelNumber  !== undefined && { hotelNumber:  body.hotelNumber }),
        ...(body.hotelZip     !== undefined && { hotelZip:     body.hotelZip }),
        ...(body.hotelCity    !== undefined && { hotelCity:    body.hotelCity }),
        ...(body.hotelState   !== undefined && { hotelState:   body.hotelState }),
        ...(body.hotelCountry !== undefined && { hotelCountry: body.hotelCountry }),
