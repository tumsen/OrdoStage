...
const en = {
  ...
  time: {
    ...
    categoryCompSettlementEarned: "Comp + (week)",
    categoryCompSettlementUsed: "Comp − (week)",
...
const da: DeepPartial<typeof en> = {
  ...
  time: {
    ...
    categoryCompSettlementEarned: "Afspadsering + (uge)",
    categoryCompSettlementUsed: "Afspadsering − (uge)",
