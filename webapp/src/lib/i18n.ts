...
const en = {
  ...
  account: {
    ...
    deleteHint:
      "This removes your OrdoStage login and sessions. If you are the only member of your organization, the organization and its data are deleted. If you are an owner with other members, transfer ownership first (Teams page).",
