...
const en = {
  ...
  time: {
    ...
    leaveVacationRemaining: "Vacation",
    leaveVacationYearCurrent: "Vacation {{year}}",
    leaveVacationYearNext: "Next {{year}}",
    leaveExtraRemaining: "Feriefridage",
    leaveCompRemaining: "Comp time",
    ...
    leaveHoursInputHint: "hhhh:mm or decimal (e.g. 37:30 / 37.5)",
