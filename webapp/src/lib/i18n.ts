...
const en = {
  ...
  time: {
    ...
    leaveWorkAccount: "Work time account",
    periodNorm: "Norm",
    periodRegistered: "Registered",
    periodDeviation: "Overtime",
    periodUsedShort: "used",
    periodLeftShort: "left",
    ...
    importSubtitle: "Import hours from Timerly CSV exports. Map projects and tags before importing. Re-imports skip entries that already exist (same person and exact time span — project/category ignored after remaps).",
    ...
    importEntriesSkippedDuplicates: "already existed (skipped)",
    importEntriesShiftedOverlaps: "auto-shifted to avoid overlap",
    importEntriesDroppedLunch: "lunch breaks removed (on top of other time)",
    importEntriesReplacedExisting: "existing entries replaced on import days",
    importEntriesSkippedOther: "skipped for other reasons",
    ...
    reportCompPeriodHint: "Earned − used in period (ledger)",
    reportCompBalanceHint: "Afspadsering rest at period end (ledger)",
    reportWorkAccountEqualsOvertime: "same as overtime for the period",
...
const da: DeepPartial<typeof en> = {
  ...
  time: {
    ...
    importSubtitle: "Importer timer fra Timerly CSV. Map projekter og tags før import. Genimport springer poster over, der allerede findes (samme person og præcis start/slut — projekt/kategori ignoreres efter remap).",
    importTabImport: "Import",
    ...
    importEntriesSkippedDuplicates: "fandtes allerede (sprunget over)",
    importEntriesShiftedOverlaps: "rykket automatisk for at undgå overlap",
    importEntriesDroppedLunch: "frokost/pause fjernet (lå oven på anden tid)",
    importEntriesReplacedExisting: "eksisterende poster erstattet på importdage",
    importEntriesSkippedOther: "sprunget over af andre årsager",
    ...
    leaveWorkAccount: "Arbejdstidskonto",
    periodNorm: "Norm",
    periodRegistered: "Registreret",
    periodDeviation: "Overarbejde",
    periodUsedShort: "brugt",
    periodLeftShort: "rest",
    ...
    reportCompPeriodHint: "Optjent − brugt i perioden (ledger)",
    reportCompBalanceHint: "Afspadsering rest ved periodens slut (ledger)",
    reportWorkAccountEqualsOvertime: "samme som overarbejde i perioden",
