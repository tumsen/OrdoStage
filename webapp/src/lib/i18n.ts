...
const en = {
  ...
  time: {
    ...
    catalogLeaveCategoryHint:
      "Only system projects (Ferie, Feriefridag, Sygdom, Helligdag, Afspadsering). Each accepts only its matching leave category — you cannot add your own projects here.",
    ...
    leaveCompPeriodUsed: "Comp time used this period",
...
const da: DeepPartial<typeof en> = {
  ...
  time: {
    ...
    month: "Måned",
    dayView: "Dag",
    backToMonth: "Tilbage til måned",
    backToWeek: "Tilbage til uge",
    ...
    leaveCompPeriodUsed: "Afspadseret denne periode",
    ...
    catalogLeaveCategoryHint:
      "Kun systemprojekter (Ferie, Feriefridag, Sygdom, Helligdag, Afspadsering). Hvert projekt accepterer kun den matching fraværskategori — du kan ikke oprette egne projekter her.",
    catalogMoveAllEntriesHint:
