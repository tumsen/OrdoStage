    ...
    <>
      <div className="flex items-center justify-between mb-4 gap-3 flex-wrap">
        <div>
          ...
          <p className="text-xs text-white/30 mt-0.5">Everyone who can sign in to your organisation. Manage people and access from the <strong className="text-white/45">People</strong> page.</p>
        </div>
      </div>
        ...
        <AlertDialogContent className="bg-[#16161f] border-white/10 text-white">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-white/50">
              {removeTarget?.name} will lose access to the organisation. You can restore access from the People page.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
